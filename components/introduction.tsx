            ...
            <div className="z-20 grid items-center h-full p-6 py-20 md:py-0 md:grid-cols-2">
                ...
                <div className="flex flex-col justify-center max-w-md">
                    ...
                    <div className="flex items-center justify-center gap-3 md:justify-start md:gap-10">
                        <a href="https://github.com/keinner-dev" className="px-3 py-2 my-2 transition-all border-2 cursor-pointer text-md w-fit rounded-xl hover:shadow-xl hover:shadow-white/50">
                            Ver proyectos
                        </a>
                        <a href="https://www.linkedin.com/in/keinner-frontado-480620321/"
